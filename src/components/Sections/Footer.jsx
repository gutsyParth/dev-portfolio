      ...
      <div className="relative z-10 px-6 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <motion.div
                className="inline-flex items-center space-x-3 text-2xl font-semibold"
              ...
              >
                Full Stack Engineer focused on scalable backend
                systems, distributed architectures, real-time
                applications, and enterprise software engineering
            ...
            >
              ...
              >
                © {new Date().getFullYear()} Parth Yadav.
                All rights reserved.
              </p>
            ...
            <motion.div variants={itemVariants}>
              <motion.button
                onClick={scrollToTop}
                className={`inline-flex items-center space-x-2 px-5 py-3 rounded-full font-medium transition-all duration-300 border backdrop-blur-sm ${
                  isDarkMode
