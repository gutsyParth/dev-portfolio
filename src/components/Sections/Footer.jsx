        ...
        <div className='absolute top-0 left-0 w-full h-px overflow-hidden'>
            <motion.div
                className={`h-px bg-gradient-to-r ${isDarkMode
                    ? 'from-transparent via-blue-500 to-transparent' : "via-blue-600 to-transparent"
                    }`}
                ...
                <div className='max-w-6xl mx-auto'>
                    ...
                    <motion.div initial="hidden" animate={isInView ? "visible" : "hidden"} variants={containerVariants} className='text-center space-y-8'>
                        ...
                        >
                            ...
                            <motion.div
                                className='inline-flex items-center space-x-2 text-2xl font-medium' whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 400 }}
                            >
                        ...
                        <motion.div variants={itemVariants} className='space-y-2'>
                            <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-600"}`}>
                                ©{new Date().getFullYear()} Parth Yadav. All rights reserved.
                            </p>
                            <p className={`text-xs ${isDarkMode ? "text-gray-600" : "text-gray-500"}`}>
                                Built with React, Framer Motion, and a lot of ☕.
                            </p>
                        </motion.div>

                        <motion.div variants={itemVariants}>
                            <motion.button onClick={scrollToTop} className={`inline-flex items-center space-x-2 px-4 py-2 rounded-full font-medium transition-all duration-300 ${isDarkMode ? "bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 hover:text-white" : "bg-gray-100/50 hover:bg-gray-200/50 text-gray-600 hover:text-gray-900"
                                } backdrop-blur-sm border ${isDarkMode ? "border-gray-700" : "border-gray-300"}`} whileHover={{ y: -2, scale: 1.05, boxShadow: isDarkMode ? "0 10px 25px rgba(59,130,246,0.15" : "0 10px 25px rgba(59,130,246,0.1" }} whileTap={{ scale: 0.95 }}>
